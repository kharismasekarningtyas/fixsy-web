...
.card.yellow { background:  #56ab2f }
.card.blue { background: #56ab2f }
.card.gray { background:  #56ab2f }
...
<div class="main expand" id="main">
  ...
  <div class="overview">
    ...
    <!-- Setiap card menunjukkan data berbeda -->
      <div class="card yellow" onclick="window.location.href='guest_asset.php'" style="cursor: pointer;">
        <div class="card-icon">📋</div>
        <div><strong>Assets</strong></div>
      </div>
      <div class="card blue" onclick="window.location.href='guest_handover.php'" style="cursor: pointer;">
