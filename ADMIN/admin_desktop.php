...
<div class="card yellow" onclick="window.location.href='admin_asset.php'" style="cursor: pointer;">
        <div class="card-icon">📋</div>
        <div><strong>Assets</strong></div>
      </div>
      <div class="card gray" onclick="window.location.href='admin_mainte.php'" style="cursor: pointer;">
        <div class="card-icon">🛠️</div>
        <div><strong>Maintenance</strong></div>
      </div>
      <div class="card blue" onclick="window.location.href='admin_handover.php'" style="cursor: pointer;">
